...
void forwardPass(double training_inputs[numTrainingSets][numInputs],
                 ...
                 int i) 
{
    ...
    printf("Input:%g  Output:%g    Output: %g\n",
...
void backpropagation(double training_inputs[numTrainingSets][numInputs],
...
int main(void) 
{
    ...
    for (int epochs = 0; epochs < numberOfEpochs; epochs++) 
	{
        ...
        for (int x = 0; x < numTrainingSets; x++) 
		{
            ...
            // Forward pass
            forwardPass(training_inputs, hiddenLayer, outputLayer,
                        hiddenLayerBias, outputLayerBias,
                        hiddenWeights, outputWeights, i);

			
            // Backpropagation
            backpropagation(training_inputs, training_outputs, hiddenLayer,
                            outputLayer, hiddenLayerBias, outputLayerBias,
                            hiddenWeights, outputWeights, lr, i);
        }
    }
